...
export declare class ComponentRepositorySequenceIterator implements BidirectionalIterator<Component<any>> {
    /**
    *
    */
    ...
    * @see Iterator.move
    */
    move(iterator: CollectionIterator<Component<any>>): void;
    /**
