...
export class EntityTypeSequenceIterator implements BidirectionalIterator<ComponentType<any>> {
  /**
  *
  */
  public sequence : EntityTypeSequence
  ...
  */
  public collection () : EntityTypeSequence {
  ...
  */
  public move (iterator : CollectionIterator<ComponentType<any>>) : void {
    if (iterator instanceof EntityTypeSequenceIterator) {
  ...
  * @param toCopy
  */
  public copy (toCopy : EntityTypeSequenceIterator) : void {
  ...
  * @see Iterator.clone
  */
  public clone () : EntityTypeSequenceIterator {
    const copy : EntityTypeSequenceIterator = new EntityTypeSequenceIterator()
  ...
  */
  public equals (other : any) : boolean {
    ...
    if (other instanceof EntityTypeSequenceIterator) {
...
export namespace ComponentRepositorySequenceIterator {
  ...
  * @return A shallow copy of the given iterator.
  */
  export function copy (toCopy : EntityTypeSequenceIterator) : EntityTypeSequenceIterator {
