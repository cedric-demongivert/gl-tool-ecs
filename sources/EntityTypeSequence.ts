...
export class EntityTypeSequence implements Sequence<ComponentType<any>> {
  ...
  public hasInSubsequence(element: ComponentType<any>, offset: number, size: number): boolean {
    return this._source.hasInSubsequence(this._mapping.get(element), offset, size)
  }
  ...
  public indexOf(element: ComponentType<any>): number {
    return this._source.indexOf(this._mapping.get(element))
  }
  ...
  public indexOfInSubsequence(element: ComponentType<any>, offset: number, size: number): number {
    return this._source.indexOfInSubsequence(this._mapping.get(element), offset, size)
  }
