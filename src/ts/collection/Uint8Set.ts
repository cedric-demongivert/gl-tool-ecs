...
export class Uint8Set implements StaticSet<number> {
  /**
  * Maximum number capacity of a Uint8Set.
  */
  static MAX_CAPACITY : number = 0xff + 1
  ...
  */
  static copy (toCopy : Uint8Set) : Uint8Set {
    const result : Uint8Set = new Uint8Set(toCopy.capacity)
  ...
  private _sparse: Uint8Array
  private _dense: Uint8Array
  ...
  */
  public constructor (capacity : number = 16) {
    this._sparse = new Uint8Array(capacity)
    this._dense = new Uint8Array(capacity)
    this._size = 0
  }
  ...
  */
  public reallocate (capacity : number) : void {
    const oldDense : Uint8Array = this._dense
    const oldSparse : Uint8Array = this._sparse
  ...
  */
  public fit () : void {
    ...
    if (max == null) {
      this._dense = new Uint8Array(0)
      this._sparse = new Uint8Array(0)
    } else {
      this._dense = new Uint8Array(max + 1)
      this._sparse = new Uint8Array(max + 1)
