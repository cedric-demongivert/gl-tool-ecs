...
import { BufferedNumberSet } from '../../src/ts/collection/BufferedNumberSet'

describe('BufferedNumberSet', function () {
  describe('#constructor', function () {
    it('create an empty set with an initial capacity of 16 elements', function () {
      const set : BufferedNumberSet = new BufferedNumberSet()
    ...
    it('create an empty set with a given capacity', function () {
      const set : BufferedNumberSet = new BufferedNumberSet(800)
  ...
  describe('#copy', function () {
    it('copy an existing set', function () {
      const set : BufferedNumberSet = new BufferedNumberSet(40)

      for (let index = 0; index < 40; ++index) {
        if (index % 2 == 0 && index % 3 == 0) set.add(index)
      }

      const copy : BufferedNumberSet = BufferedNumberSet.copy(set)
  ...
  describe('#reallocate', function () {
    ...
    it('allows to reduce the storing capacity of the set', function () {
      const set : BufferedNumberSet = new BufferedNumberSet(500)
  ...
  describe('#fit', function () {
    it('optimize the storing capacity of the set', function () {
      const set : BufferedNumberSet = new BufferedNumberSet(80)
  ...
  describe('#max', function () {
    it('return the maximum element of the set', function () {
      const set : BufferedNumberSet = new BufferedNumberSet(80)

      for (let index = 10; index < 20; ++index) set.add(index * 2)
      for (let index = 0; index < 10; ++index) set.add(index * 2)
      ...
      expect(set.max()).toBe(38)
    })

    it('return undefined if the set is empty', function () {
      const set : BufferedNumberSet = new BufferedNumberSet(40)
  ...
  describe('#min', function () {
    it('return the minimum element of the set', function () {
      const set : BufferedNumberSet = new BufferedNumberSet(80)
  ...
  describe('#equals', function () {
    it('it return true if both element set are equals', function () {
      const set : BufferedNumberSet = new BufferedNumberSet(80)
      const copy : BufferedNumberSet = new BufferedNumberSet(80)
      const differentSize : BufferedNumberSet = new BufferedNumberSet(80)
      const differentContent : BufferedNumberSet = new BufferedNumberSet(80)
      const differentCapacity : BufferedNumberSet = new BufferedNumberSet(70)
