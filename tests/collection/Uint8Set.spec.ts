...
import { Uint8Set } from '../../src/ts/collection/Uint8Set'

describe('Uint8Set', function () {
  describe('#constructor', function () {
    it('create an empty set with an initial capacity of 16 elements', function () {
      const set : Uint8Set = new Uint8Set()
    ...
    it('create an empty set with a given capacity', function () {
      const set : Uint8Set = new Uint8Set(200)
  ...
  describe('#copy', function () {
    it('copy an existing set', function () {
      const set : Uint8Set = new Uint8Set(40)

      for (let index = 0; index < 40; ++index) {
        if (index % 2 == 0 && index % 3 == 0) set.add(index)
      }

      const copy : Uint8Set = Uint8Set.copy(set)
  ...
  describe('#reallocate', function () {
    ...
    it('allows to reduce the storing capacity of the set', function () {
      const set : Uint8Set = new Uint8Set(80)
  ...
  describe('#equals', function () {
    it('it return true if both element set are equals', function () {
      const set : Uint8Set = new Uint8Set(80)
      const copy : Uint8Set = new Uint8Set(80)
      const differentSize : Uint8Set = new Uint8Set(80)
      const differentContent : Uint8Set = new Uint8Set(80)
      const differentCapacity : Uint8Set = new Uint8Set(70)
